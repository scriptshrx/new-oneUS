...
import { pipelineStages } from '@/utils/constants';
...
const PatientsView = () => {
  ...
  return (
    <div className="flex-1 overflow-x-auto pb-4">
      <div className="px-6 flex gap-4 min-w-max pr-6">
        {pipelineStages.map((stage) => {
          const stagePatients = groupedPatients[stage.id] || [];
          
          return (
            <div key={stage.id} className={`flex-shrink-0 w-80 border-r border-slate-200 p-4 pb-3 bg-slate-50/10 rounded-lg`}>
              ...
              {/* Patient Cards */}
              <div className="space-y-3 max-h-[calc(100vh-245px)] overflow-y-auto">
...
export default PatientsView;'use client';
